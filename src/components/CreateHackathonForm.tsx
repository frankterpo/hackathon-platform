...
export function CreateHackathonForm() {
  ...
  return (
    <section className="rounded-2xl border border-white/[0.08] bg-[#101010] p-4 sm:p-5">
      <h2 className="text-sm font-semibold text-zinc-100">Create hackathon</h2>
      ...
      >
        ...
        {state.ok ? (
          <p className="rounded-lg border border-emerald-500/35 bg-emerald-500/10 px-3 py-2 text-xs text-emerald-100/95">
            Saved. Kanban will show the new row after refresh.
          </p>
        ) : null}
